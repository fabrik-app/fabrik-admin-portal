...
class AddDesigner extends React.Component {

    constructor(props) {
        super(props);
        this.state = {
            isBusy: false,
            pageTitle: "Create new Designer",
            designer: {
                id: null,
                slug: "",
                isActive: true,
    ...
    handleSubmit(event) {
        ...
        var createDesignerApiEndpoint = config.apiBaseUrl + 'designers';
        axios.post(createDesignerApiEndpoint, this.state.designer, {
...
export default privateRoute(AddDesigner);