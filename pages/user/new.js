...
class CreateUser extends React.Component {
    ...
    handleSubmit(event) {
        ...
        var dataApiEndpoint = config.apiBaseUrl + 'users';
        axios.post(dataApiEndpoint, this.state.data, {
                    ...
                    <h4>Primary Details</h4>
                        ...
                        <div className="form-row">
                            ...
                            <label htmlFor="country">Country</label>
                                <select id="country" name="data.country" value={this.state.data.country}
                                    className="form-control"
                                    onChange={this.handleInputChange}>
...
export default privateRoute(CreateUser);