...
class Websites extends React.Component {
    ...
    componentDidMount() {
        var websitesApiEndpoint = config.robotsApiBaseUrl + 'websites/manage?page=' + this.state.pagingInfo.currentPage;
    ...
    loadNextPage() {
        ...
        var websitesNextPageApiEndpoint = config.robotsApiBaseUrl + 'websites/manage?page=' + nextPage;
