...
class AddContact extends React.Component {
    ...
    handleSubmit(event) {
        ...
        .then(apiResult => {
            ...
            NotificationManager.alert("Contact created Successfully");
            ...
            content = <div className="container">
                <nav aria-label="breadcrumb">
                    <ol className="breadcrumb">
                        ...
                        <li className="breadcrumb-item"><Link href="/contacts"><a>Contacts</a></Link></li>
                        <li className="breadcrumb-item"><a>{this.state.pageTitle}</a></li>
                    </ol>
                </nav>
