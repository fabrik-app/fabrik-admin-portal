...
class EditStoreBranch extends React.Component {

    constructor(props) {
        super(props);
        this.state = {
            isBusy: false,
            pageTitle: "Update Store Branch",
            data: props.data,
    ...
    static async getInitialProps(props) {
        ...
        var apiUrl = config.apiBaseUrl + 'stores/' + props.query.slug + "/branches/" + props.query.id;
        ...
        data.workingHours.map((workingHour, i) =>{
            workingHour.start = moment.utc(workingHour.start).local().format('HH:mm:ss');
            workingHour.end = moment.utc(workingHour.end).local().format('HH:mm:ss');
        });
    ...
    handleSubmit(event) {
        ...
        var apiUrl = config.apiBaseUrl + 'stores/' + this.props.storeSlug + "/branches/" + this.props.data.id;
        axios.put(apiUrl, this.state.data, {
            ...
            .then(apiResult => {
                ...
                NotificationManager.alert("Branch updated Successfully");
                        ...
                        <div className="form-row">
                            <div className="form-group">
                                ...
                                <textarea className="form-control" id="data.address.street" rows="4" cols="50"
                                    ...
                                    onChange={this.handleInputChange} aria-describedby="emailHelp" placeholder="Enter Address (Area and Street)" />
                            </div>
                        </div>
                        <div className="form-row">
                            <div className="form-group col-md-4">
...
export default privateRoute(EditStoreBranch);