...
class AddStore extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            services: [
                { text: 'Materials', checked: true },
                { text: 'Designing', checked: true },
    ...
    handleSubmit(event) {
        ...
        var createStoreUrl = config.apiBaseUrl + 'stores';
        axios.post(createStoreUrl, this.state.data, {
        ...
        .then(apiResult => {
            ...
            NotificationManager.alert("Store created Successfully");
    ...
    render() {
        ...
        if (this.state.isBusy) {
            content = <BusyIndicator message="Saving Store details" />;
        }
        else {
            content = <div className="container">
                ...
                <form role="form" onSubmit={this.handleSubmit} className="mb-5">
                    ...
                    <div className="form-section">
                        <h4>Social Media</h4>
                        <hr />
                        <button className="btn btn-secondary" type="button" onClick={() => this.onAddSocialMedia()}><i className="fas fa-plus"></i></button>
                        {this.state.socialMedia.map((media, i) =>
                            <div className="form-row" key={i}>
                                ...
                                <div className="form-group col-md-2">
                                    <button className="btn btn-danger mt-4" type="button" onClick={() => this.onRemoveSocialMedia(i)}><i className="fas fa-trash"></i></button>
                                </div>
                            </div>
                        )}
                    </div>
...
export default privateRoute(AddStore);